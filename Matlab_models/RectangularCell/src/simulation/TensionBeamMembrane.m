classdef TensionBeamMembrane < LineSimulation
	...
	methods
		...
		function obj = TensionBeamMembrane(nCells, p, g, w, b, seed, varargin)
			...
			if b > 0
				obj.AddTissueBasedForce(BasementMembraneBeamForce(b));
			else
			...
			% obj.AddDataWriter(WriteSpatialState(20,'TensionBeamMembrane/'));
			pathName = sprintf('TensionBeamMembrane/p%dg%dw%db%d_seed%d/',p,g,w,b,seed);
