classdef SupportingTissueMembrane < LineSimulation
	...
	methods
		...
		function obj = SupportingTissueMembrane(nCells, p, g, w, b, seed, varargin)
			...
			obj.AddDataWriter(WriteSpatialState(20,'SupportingTissueMembrane/'));
			% pathName = sprintf('SupportingTissueMembrane/p%dg%dw%db%d_seed%d/',p,g,w,b,seed);
