classdef MerzoukiRing < RingSimulation
	...
	methods
		...
		function obj = MerzoukiRing(nCells, p, g, seed)
			% All the initilising
			obj.SetRNGSeed(seed);

			% p is the probability of division in an hour
			% g is the amount of growth in an hour
			...
			pathName = sprintf('MerzoukiRing/n%gp%gg%g_seed%g/',nCells,p,g,seed);
