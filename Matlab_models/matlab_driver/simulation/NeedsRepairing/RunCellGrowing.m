classdef RunCellGrowing < MatlabSimulation
	...
	methods
		function obj = RunCellGrowing(t, n, p, g, Pa, Pp, Padh, seed)
			% The constructor for the runCellGrowing object
	...
	methods (Access = protected)
		...
		function GenerateSaveLocation(obj)
			...
			obj.saveLocation = [obj.saveLocation, sprintf('/t_%d_dt_%g',obj.t,obj.dt)];
