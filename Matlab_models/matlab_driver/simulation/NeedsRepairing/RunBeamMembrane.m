classdef RunBeamMembrane < MatlabSimulation
	...
	methods
		function obj = RunBeamMembrane(n, p, g, w, b, seed)
			% The constructor for the runBeamMembrane object
			...
			obj.simObj = BeamMembrane(n, p, g, w, b, seed);
