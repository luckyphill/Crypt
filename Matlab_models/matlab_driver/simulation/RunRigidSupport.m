classdef RunRigidSupport < MatlabSimulation
	...
	methods
		function obj = RunRigidSupport(n, p, g, w, b, seed)
			% The constructor for the runRigidSupport object
			...
			obj.simObj = RigidSupport(n, p, g, w, b, seed);
	...
	methods (Access = protected)
		...
		function GenerateSaveLocation(obj)
			...
			obj.saveLocation = [obj.researchPath, 'Research/Crypt/Data/Matlab/SimulationOutput/', obj.matlabTest, '/', sprintf('n%dp%gg%gw%gb%g_seed%g',obj.n,obj.p,obj.g,obj.w,obj.b,obj.rngSeed), '/'];
