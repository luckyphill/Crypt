classdef SSWiggleRatioBeamMembranePinnedAnalysis < Analysis
	...
	properties
		...
		analysisName = 'SSWiggleRatioBeamMembranePinnedAnalysis';
	...
	methods
		...
		function obj = SSWiggleRatioBeamMembranePinnedAnalysis()
					...
					for b = obj.b
						...
						for seed = obj.seed
							try
								...
								a = RunBeamMembranePinned(2*w, p, g, w, b, seed);
