...
namespace boost
{
	namespace serialization
	{
		...
		inline void save_construct_data(Archive & ar, const SimpleSloughingCellKiller<SPACE_DIM> * t, const unsigned int file_version)
		{
		...
		template<class Archive, unsigned  SPACE_DIM>
		inline void load_construct_data(Archive & ar, SimpleSloughingCellKiller<SPACE_DIM> * t, const unsigned int file_version)
		{
