function obj = RatColonDesc(data)
    ...
    obj =  penalty(100*anoikis_rate,1,4,1) + penalty(average_cell_count,40,44,1) + penalty(max_division_position,31,34,1) + penalty(100*birth_rate,40,44,1);
