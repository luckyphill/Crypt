classdef simulateCryptColumnSingleMutation < chasteSimulation
	...
	properties (SetAccess = immutable)
		...
		chasteTest = 'TestCryptColumnSingleMutation'
	...
	methods
		function obj = simulateCryptColumnSingleMutation(simParams, mutantParams, solverParams, seedParams, outputTypes)
			% The constructor for the simulateCryptColumnSingleMutation object
