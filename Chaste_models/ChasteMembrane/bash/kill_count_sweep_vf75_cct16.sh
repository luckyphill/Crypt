...
#SBATCH --mem=4GB 
#SBATCH --array=0-4000
#SBATCH --err="output/kill_count_cct16_%a.err" 
#SBATCH --output="output/kill_count_cct16_%a.out" 
#SBATCH --job-name="kill_count_cct16"
# NOTIFICATIONS
...
if [ $found = 1 ]; then
	...
	/home/a1738927/fastdir/chaste_build/projects/ChasteMembrane/test/TestCryptCrossSection -ees ${es} -ms ${ms} -vf 0.75 -cct 16
else 
