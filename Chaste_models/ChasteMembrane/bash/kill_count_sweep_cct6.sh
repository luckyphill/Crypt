...
#SBATCH --mem=4GB 
#SBATCH --array=0-7564
#SBATCH --err="output/kill_count_cct6_%a.err" 
#SBATCH --output="output/kill_count_cct6_%a.out" 
#SBATCH --job-name="kill_count_cct6"
# NOTIFICATIONS
...
if [ $found = 1 ]; then
	...
	/home/a1738927/fastdir/chaste_build/projects/ChasteMembrane/test/TestCryptCrossSection -ees ${es} -ms ${ms} -vf ${vf} -cct 6
else 
