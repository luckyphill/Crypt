...
limits = {[20,40],[9,16],[10,200],[20,400],[12,18],[0.6, 0.95],[1,1000]};
min_step_size = [1,1,1,1,1,0.01,1];


find_optimal_region('TestCryptNewPhaseModel', @MouseColonDesc, input_flags, prange, limits, min_step_size, false);