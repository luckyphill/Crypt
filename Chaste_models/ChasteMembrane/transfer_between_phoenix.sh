...
rsync -avz --progress -f"+ */" -f"+ *.hpp" -f"+ *.cpp" -f"+ *.sh" -f"+ *.txt" -f"+ *.m" -f"+ *.py" -f"- *.*" --delete . a1738927@phoenix.adelaide.edu.au:/fast/users/a1738927/Research/Crypt/Chaste_models/ChasteMembrane/