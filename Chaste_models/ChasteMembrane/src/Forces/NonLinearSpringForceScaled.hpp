...
#ifndef NONLINEARSPRINGFORCESCALED_HPP_
#define NONLINEARSPRINGFORCESCALED_HPP_
...
class NonLinearSpringForceScaled : public AbstractForce<ELEMENT_DIM, SPACE_DIM>
{
...
public:
     ...
     * Constructor.
     */
    NonLinearSpringForceScaled();

    /**
     * Destructor.
     */
    virtual ~NonLinearSpringForceScaled();
...
#endif /*NONLINEARSPRINGFORCESCALED_HPP_*/
