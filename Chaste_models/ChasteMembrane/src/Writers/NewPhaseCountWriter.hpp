...
#ifndef NewPHASECOUNTWRITER_HPP_
#define NewPHASECOUNTWRITER_HPP_
...
class NewPhaseCountWriter : public AbstractCellPopulationCountWriter<ELEMENT_DIM, SPACE_DIM>
{
private:
...
#endif /*NewPHASECOUNTWRITER_HPP_*/
