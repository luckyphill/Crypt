#ifndef EpithelialCELLPositionWRITER_HPP_
#define EpithelialCELLPositionWRITER_HPP_
...
class EpithelialCellPositionWriter : public AbstractCellWriter<ELEMENT_DIM, SPACE_DIM>
{
private:
...
#endif /* EpithelialCELLPositionWRITER_HPP_ */