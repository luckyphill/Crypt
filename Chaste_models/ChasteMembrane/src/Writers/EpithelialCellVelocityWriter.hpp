#ifndef EpithelialCELLVelocityWRITER_HPP_
#define EpithelialCELLVelocityWRITER_HPP_
...
class EpithelialCellVelocityWriter : public AbstractCellWriter<ELEMENT_DIM, SPACE_DIM>
{
private:
...
#endif /* EpithelialCELLVelocityWRITER_HPP_ */