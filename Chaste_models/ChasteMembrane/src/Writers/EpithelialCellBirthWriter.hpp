#ifndef EpithelialCELLBirthWRITER_HPP_
#define EpithelialCELLBirthWRITER_HPP_
...
class EpithelialCellBirthWriter : public AbstractCellWriter<ELEMENT_DIM, SPACE_DIM>
{
private:
...
#endif /* EpithelialCELLBirthWRITER_HPP_ */