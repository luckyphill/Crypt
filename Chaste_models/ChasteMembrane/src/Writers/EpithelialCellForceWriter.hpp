#ifndef EpithelialCELLForceWRITER_HPP_
#define EpithelialCELLForceWRITER_HPP_
...
class EpithelialCellForceWriter : public AbstractCellWriter<ELEMENT_DIM, SPACE_DIM>
{
private:
...
#endif /* EpithelialCELLForceWRITER_HPP_ */