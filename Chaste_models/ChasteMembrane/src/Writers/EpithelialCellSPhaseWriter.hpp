#ifndef EpithelialCELLSPHASEWRITER_HPP_
#define EpithelialCELLSPHASEWRITER_HPP_
...
class EpithelialCellSPhaseWriter : public AbstractCellWriter<ELEMENT_DIM, SPACE_DIM>
{
private:
...
#endif /* EpithelialCELLSPHASEWRITER_HPP_ */