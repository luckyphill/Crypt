...
#SBATCH --mem=4GB 
#SBATCH --array=0-4000
#SBATCH --err="output/kill_count_vf80_%a.err" 
#SBATCH --output="output/kill_count_vf80_%a.out" 
#SBATCH --job-name="kill_count_vf80"
# NOTIFICATIONS
...
if [ $found = 1 ]; then
	...
	/home/a1738927/fastdir/chaste_build/projects/ChasteMembrane/test/TestCryptCrossSection -ees ${es} -ms ${ms} -vf 0.8
else 
